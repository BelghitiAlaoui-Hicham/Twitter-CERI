<!-- SI ce n'est pas l'utilisateur connecter , il va juste lui afficher les twittes associés à ce dernier-->
<?php 
	$user = $context->user;
...
<div id="profile-page" class="section">
            ...
            <div id="profile-page-content" class="row">
              ...
              <?php if($context->user->id == context::getSessionAttribute('login')[0]['id']){?>
               <!-- profile-page-wall -->
